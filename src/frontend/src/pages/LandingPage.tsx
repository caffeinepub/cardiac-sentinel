...
import { Heart, Shield, AlertCircle, Activity, Download } from 'lucide-react';
      ...
      <div className="min-h-screen">
        ...
        <section className="bg-muted/30 py-12 md:py-16 lg:py-24">
          <div className="container mx-auto px-4">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">How Cardiac Sentinel Works</h2>
        ...
        <section className="container mx-auto px-4 py-12 md:py-16 lg:py-24">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-8 md:mb-12 text-center">Emergency Response Process</h2>
            <div className="space-y-6 md:space-y-8">
              <div className="flex gap-4 md:gap-6 items-start">
                <div className="flex-shrink-0 h-10 w-10 md:h-12 md:w-12 rounded-full bg-destructive text-destructive-foreground flex items-center justify-center font-bold text-base md:text-lg">
                  1
                </div>
                <div>
                  <h3 className="text-lg md:text-xl font-semibold mb-2">Detection</h3>
              ...
              <div className="flex gap-4 md:gap-6 items-start">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold mb-2">Alert Transmission</h3>
                  <p className="text-sm md:text-base text-muted-foreground">
              ...
              <div className="flex gap-4 md:gap-6 items-start">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold mb-2">Medical Dispatch</h3>
                  <p className="text-sm md:text-base text-muted-foreground">
              ...
              <div className="flex gap-4 md:gap-6 items-start">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold mb-2">Life-Saving Care</h3>
                  <p className="text-sm md:text-base text-muted-foreground">
        ...
        {/* CTA Section */}
        <section className="bg-destructive/5 py-12 md:py-16 lg:py-24">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">Ready to Protect Your Heart?</h2>
